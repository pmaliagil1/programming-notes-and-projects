...
data class Venta(val cliente: String, val dia: Int, val monto: Double, val domicilio: String)
...
fun main() {
    ...
    val domiciliosParaFactura = obtenerDomiciliosUnicos(ventasMes)

    println("Domicilios para envío de facturas (sin repeticiones):")
    for (domicilio in domiciliosParaFactura) {
        println("- $domicilio")
    }
}
