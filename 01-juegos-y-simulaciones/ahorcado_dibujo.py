...
def ahorcado():
    ...
    while "_" in palabra_oculta:
        print(AHORCADO[intentos])  # Muestra el estado del ahorcado según el número de intentos
    ...
    print(AHORCADO[intentos])  # Muestra el dibujo final si se llega al límite de intentos
